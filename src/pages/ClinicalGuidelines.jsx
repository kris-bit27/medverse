                ...
                >
                  <CardContent className="p-4">
                    <div className="flex items-start gap-3">
                      <FileText className="w-5 h-5 text-[hsl(var(--mn-accent))] mt-0.5 flex-shrink-0" />
                ...
                <CardContent className="space-y-4">
                  ...
                  {selectedGuideline.source_url && (
                    <a
                      ...
                      className="flex items-center gap-2 text-[hsl(var(--mn-accent))] hover:underline text-sm"
                    >
